...
>
> **Addendum (August 9, 2026, second pass) — reviewed, then re-architected.** Two follow-on sessions the same day (FINDINGS.md Design Sessions 2–3) revised the addendum above on both of its claims.
>
