...
struct ContactDraft {
    ...
    var phoneNumbers: [PhoneNumberDraft] = []
    var emailAddresses: [EmailAddressDraft] = []
    var postalAddresses: [PostalAddressEntryDraft] = []
    var urlAddresses: [URLAddressDraft] = []
    ...
    init(
        ...
        emailAddresses: [EmailAddressDraft] = [],
        postalAddresses: [PostalAddressEntryDraft] = [],
        urlAddresses: [URLAddressDraft] = [],
    ...
    init(from cnContact: CNContact) {
        ...
        self.phoneNumbers = cnContact.phoneNumbers.map { PhoneNumberDraft(from: $0) }
        self.emailAddresses = cnContact.emailAddresses.map { EmailAddressDraft(from: $0) }
        self.postalAddresses = cnContact.postalAddresses.map { PostalAddressEntryDraft(from: $0) }
        self.urlAddresses = cnContact.urlAddresses.map { URLAddressDraft(from: $0) }
...
struct PostalAddressEntryDraft {
    var label: String
